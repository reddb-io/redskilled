...
const worktreesDir = "C:\\repo\\.red-castle\\worktrees";
const gitWorktreePath = "C:/repo/.red-castle/worktrees/feature-x";
const joinWorktreePath = "C:\\repo\\.red-castle\\worktrees\\feature-x";

describe("findCollidingWorktree", () => {
  it("matches by branch name", () => {
    const existing = [
      { path: gitWorktreePath, branch: "feature-x" },
      { path: "C:/repo/.red-castle/worktrees/other", branch: "other" },
    ];
